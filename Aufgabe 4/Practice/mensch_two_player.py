...
def figuren_schlagen():
    ...
    if g1 == b1 or g1 == b2 or g1 == b3 or g1 == b4:
        ...
        if g4 == b1 - 20 or b1 == g4 - 20 and b1 != 41 and b1 != 42 and b1 != 43 and b1 != 44:
            ...
            b4 = 0
    return g1, g2, g3, g4, b1, b2, b3, b4, g1_og, g2_og, g3_og, g4_og, b1_og, b2_og, b3_og, b4_og
...
while GameOver == False:
    ...
    #'GAMEOVER-CHECKER'
    if g1 >= 41 and g2 >= 41 and g3 >= 41 and g4 >= 41:
        GameOver = True
        print('GRUEN hat gewonnen!!!')
    elif b1 >= 41 and b2 >= 41 and b3 >= 41 and b4 >= 41:
        GameOver = True
